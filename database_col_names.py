def get_database_columns():
    '''
    A function that maps variable names from the PEW Research Center
    Questionnaire to the different choice text. Used in creating a database
    that is more user-friendly and readable when understanding the segmentation.
    ...
    OUTPUTS
    -------
    dummy_column_names: The mapping from variable names to variable choices to
                        be made into dummy variables
    column_names: The mapping from variable names to variable choices
    dummy_columns: The dummy columns to be transformed
    '''
    ...
    dummy_columns = ['LIFE', 'TOPICINT_a', 'TOPICINT_b', 'TOPICINT_c',
                    ...
                    'NEWSJOB', 'NEWSFACTS_a', 'NEWSFACTS_b', 'NEWSFACTS_c',
                    'NEWSFACTS_d', 'NEWSFACTS_e', 'NEWSFACTS_f', 'NEWSFACTS_g',
                    'NEWSFACTS_h', 'NEWSFACTS_i', 'NEWSFACTS_a_t2b',
                    'NEWSFACTS_b_t2b', 'NEWSFACTS_c_t2b', 'NEWSFACTS_d_t2b',
                    'NEWSFACTS_e_t2b', 'NEWSFACTS_f_t2b', 'NEWSFACTS_g_t2b',
                    'NEWSFACTS_h_t2b', 'NEWSFACTS_i_t2b', 'SNSUSE', 'SNSFREQ',
                    'FOLLOW', 'FOLLOWANTI', 'SNSSCI', 'SNSCLICK', 'SNSSCIIMP',
                    'SNSNEW', 'SNSTRUST', 'PROBSET_a', 'PROBSET_b', 'PROBSET_c',
                    'PROBSET_d', 'PROBSET_e', 'PROBSET_f', 'PROBSET_g',
                    'PROBSET_h', 'BLAME', 'DISCUSS', 'LEAD', 'TURN', 'ENTCRIM1',
                    'ENTCRIM1_t2b', 'ENTCRIM2', 'ENTCRIM3', 'ENTCRIM4',
                    'ENTHOSP1', 'ENTHOSP1_t2b', 'ENTHOSP2', 'ENTHOSP3',
                    'ENTHOSP4', 'ENTSCIFI1', 'ENTSCIFI1_t2b', 'ENTSCIFI2',
                    'ENTSCIFI3', 'ENTSCIFI4', 'HOBBY', 'PARTY', 'PARTYLN',
                    'IDEO', 'xparent', 'IND1', 'DOV_PPP20072', 'DOV_PPC10017',
                    'DOV_PPC20217', 'DOV_PPC21501', 'DOV_PPC11518', 'ppagecat',
                    'ppagecat_short', 'PPEDUCAT', 'PPETHM', 'PPGENDER',
                    'PPHHSIZE', 'PPHOUSE', 'PPINCIMP', 'PPMARIT', 'PPREG4',
