...
## Methodology
### Design
***Relevant files:** pipeline.py, DataExploration.ipynb, files in the 'data' folder*
...
### Segment
***Relevant files:** ClusterModels.ipynb, SelectingBestClusterModel.ipynb*
...
### Analyze
***Relevant files:** ProfilingSegments.ipynb, Seg0Charts.ipynb, Seg1Charts.ipynb, Seg2Charts.ipynb, BuildDatabase.ipynb, pipeline.py, database_col_names.py, savemodel.py*
...
### Predict
***Relevant files:** PredictingSegments.ipynb, model.py*
